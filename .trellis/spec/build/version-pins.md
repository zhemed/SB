...
|----------|-----------|-------------|
| `VERSION` | `1.9.0` (bare semver, single trailing newline) | `scripts/build.sh:67-68`, `tests/verify.sh:50-51` |
| `src/00-bootstrap.sh:94` | `sb_version="v1.9.0"` | `scripts/build.sh:155-156`, `tests/verify.sh:48-49` |
| `README.md` "当前项目版本" line | `` 当前项目版本：`1.9.0` `` | `tests/verify.sh:52-53` |
