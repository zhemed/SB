...
- **229 functions** across 11 modules. `src/10-acme.sh` (53), `src/40-service.sh` (36),
...
- All 229 function definitions are written `name(){` at **column 0** — no leading indentation, no
  space before `{`.
